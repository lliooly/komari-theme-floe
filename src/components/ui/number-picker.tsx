import { Minus, Plus } from "@/components/Icones/Reicon";
...
export default function NumberPicker({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/set-state-in-effect -- synchronize the controlled default into the input draft
